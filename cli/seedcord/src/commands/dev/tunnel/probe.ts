...
export async function awaitReachable(url: string, deps: ProbeDeps, signal: AbortSignal): Promise<void> {
    ...
    throw new SeedcordError(SeedcordErrorCode.CliTunnelUnreachable, [url, BUDGET_MS / 1000]);
}
