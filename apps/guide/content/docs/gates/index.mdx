---
title: Gates
description: Run checks before a handler with @Gated, from the gates seedcord ships and the order they run in to who counts as an owner and rewording a refusal.
---
...
`Cooldown` has [a page of its own](/gates/cooldown).
...
[Permissions](/gates/permissions) takes the permission gates in turn, including what Administrator does to them. When none of the shipped gates fits, you can [write your own](/gates/your-own) or [combine several into one](/gates/combining).
