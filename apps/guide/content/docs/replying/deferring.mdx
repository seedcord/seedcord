---
title: Deferring
description: Defer when a handler can take longer than Discord's three seconds. Set ephemeral on defer(), since the edit() that fills it doesn't take options.
---
