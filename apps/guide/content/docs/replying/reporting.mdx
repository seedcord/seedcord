...
description: Send the errors your bot reports to a Discord channel through a webhook, or write a reporter of your own.
---
...
seedcord matches every url it finds against Discord's webhook form and throws when one doesn't match. It then asks Discord about every webhook it accepted, and a 404 or a 401 throws too. That second throw lists every dead variable at once, so a first boot reports all of them together.
