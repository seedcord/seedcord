---
title: Replying
description: A handler's reply methods record what each interaction already got, so a wrong call throws with the fix and a thrown Notice still reaches the user.
---
