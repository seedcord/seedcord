...
description: Draw aligned tables into a message with renderTable, from frames, alignment, and column caps to emoji widths and splitting a long table across messages.
---
