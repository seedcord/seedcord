...
If you already know the state, call `reply()` or `edit()` directly. They throw when the state is something else, and that throw is how you find a misplaced `defer()`.
