---
title: Faults
description: The generic card for an error you catch, what seedcord does with any other throw, stopping a handler without a reply, and throws outside any handler.
---
