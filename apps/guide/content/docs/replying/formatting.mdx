...
description: Helpers for the text your bot sends, from snowflake timestamps and Discord time tags to durations, big numbers, readable names, shuffles, and objects that won't stringify.
---
