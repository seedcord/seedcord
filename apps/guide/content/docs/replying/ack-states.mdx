...
description: Discord tracks what state an interaction is in, and that decides which reply methods still work. Covers the four states, the verb each one allows, and three errors a reply call throws.
---
