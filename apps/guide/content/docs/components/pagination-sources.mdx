---
title: Sources
description: Where a paginator's items come from, from fetching one page at a time with CursorSource to the PageView every source returns and writing a source of your own.
---
