---
title: Pagination
description: Page through a long list with Paginator, from wiring its nav handler and starting it from a command to loading the items and rendering each one.
---
