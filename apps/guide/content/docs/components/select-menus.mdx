---
title: Select menus
description: Handle select menu picks, from a string menu with options you write to the menus that resolve users, roles, and channels, and one handler serving several menus.
---
