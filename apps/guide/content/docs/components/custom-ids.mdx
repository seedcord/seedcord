---
title: Custom IDs
description: Declare what a component's custom id carries with CustomId, from the field kinds and nullable fields to what each value costs on the wire, reading an id back by hand, and clicks the router skips.
---
