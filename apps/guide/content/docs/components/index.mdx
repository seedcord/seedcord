---
title: Components
description: Anything your bot sends with structure gets a class over its discord.js builder, which names it, types it, and carries your bot color.
---
...
A plain string names an application emoji, one you upload to your app in the developer portal. Run `seedcord codegen` after you change that block. It writes the key names into [`EmojiMap`](ref:types/EmojiMap), which types the [`Emojis`](ref:gateway/Emojis) accessor.
