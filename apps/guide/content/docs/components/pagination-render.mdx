...
description: Take over a paginator's whole message with render, from what it can return to placing the nav buttons yourself with controls and restyling them one at a time.
---
