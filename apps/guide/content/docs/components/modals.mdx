---
title: Modals
description: Collect text, menu picks, files, and checkboxes with a modal, from building the form and opening it with showModal to reading each field back and rewriting the message it came from.
---
