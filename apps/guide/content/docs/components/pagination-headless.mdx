...
description: Page a message without a Paginator using paginate, from the cases that need it to declaring your own cursor, what paginate returns, and where the buttons keep working.
---
