---
title: Buttons
description: Handle a button click with ButtonHandler, from reading the values its custom id carries and rewriting the message it came from to one handler serving several buttons.
---
