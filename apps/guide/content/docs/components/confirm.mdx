...
description: Ask for a second click before a destructive action with getConfirmation, from its options and replacing the prompt after an answer to building the prompt's buttons yourself.
---
...
seedcord deletes the prompt once someone answers or the wait runs out. A prompt that vanishes leaves your caller guessing what happened. Set one of the three outcome options to replace the prompt with your reply.
