...
description: What happens when someone clicks a component minted under an older CustomId shape, from the edits that change the shape hash to the cards the user gets and replacing them with your own.
---
