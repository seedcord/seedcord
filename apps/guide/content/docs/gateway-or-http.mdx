...
A bot that only answers commands, buttons, and modals runs on either one. The next question is where it lives. Gateway needs a process up all the time. Http needs a URL Discord can reach.
