...
├─ 5. your handler's execute()          your handler runs here
...
A gateway event runs its own order, with event middleware ahead of every handler registered for it. [Event middleware](/events/middleware) covers that order.
