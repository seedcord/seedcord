...
description: What to check when your logs say a command deployed and Discord doesn't show it, from its scope to who can see it and Discord's command limits.
---
