---
title: Options
description: Reading a command's input, and how required, choices, and channel types decide what each getter hands back.
---
...
The handler reads them by name. Hover the block below to see the types of each option.
