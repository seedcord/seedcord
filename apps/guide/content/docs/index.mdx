---
title: Start here
description: The guide to seedcord, a TypeScript framework for Discord bots built on discord.js. It takes you from an empty folder to a running bot with commands, replies, components, and gates.
---
