---
title: Linting
description: 'The seedcord rules catch a handler missing its route, a command missing @RegisterCommand, and calls that bypass the framework.'
---
...
Here is what the scaffold puts there.
