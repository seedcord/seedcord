...
description: Write your own plugin by extending Plugin. Covers which base to import, declaring where it runs, constructor options, rejecting bad options, logging, dev reloads, and putting it on npm.
---
