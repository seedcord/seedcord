---
title: Migrations
description: Create and change your Postgres tables with Kysely migrations in the kysely plugin. Covers where the files live, how they're ordered, when they run, running them yourself, and what happens when one fails.
---
