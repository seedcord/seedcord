...
description: Write a service class for each Postgres table with the kysely plugin, and read those services from any handler.
---
...
Your editor also reads that schema to suggest table names for `table`. With a `bans` table added, it offers both:
