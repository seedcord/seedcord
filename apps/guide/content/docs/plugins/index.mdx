...
- If the plugin extends `Plugin` from a second copy of `@seedcord/core`, it throws `CorePluginFromOtherCore`. That happens when the plugin and your `@seedcord` packages need different versions of `@seedcord/core`.
