...
description: Set up your bot's application in Discord's developer portal, from the token and intents to the public key an http bot verifies requests with and the invite to a server.
---
