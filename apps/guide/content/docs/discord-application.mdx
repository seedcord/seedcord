...
description: Set your bot's application up in Discord's developer portal before you write any code. Covers the token, the intents you turn on, the public key an http bot verifies requests with, and adding the bot to a server.
---
...
<Callout type="warning">
    ...
    Don't paste it where the token goes.
</Callout>
