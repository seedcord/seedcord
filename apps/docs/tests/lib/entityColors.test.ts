...
import { ENTITY_TONE_HEX, FOREGROUND_HEX } from '../../src/lib/entityColors';

const docsTokens = readFileSync(join(import.meta.dirname, '../../src/styles/tokens.css'), 'utf8');
const uiTokens = readFileSync(join(import.meta.dirname, '../../../../packages/ui/src/styles/tokens.css'), 'utf8');
