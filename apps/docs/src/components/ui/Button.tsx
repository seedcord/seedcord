...
const VARIANTS = {
    ...
    secondary: 'bg-(--accent-b) text-black shadow-soft hover:bg-(--accent-b-hover)',
    outline: 'border-(--border) bg-transparent text-(--text) hover:border-(--accent-a)/60 hover:bg-surface-subtle',
    ghost: 'bg-transparent text-(--text) hover:bg-(--bg-accent-a-transparent-subtle)'
