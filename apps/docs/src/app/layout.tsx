            ...
            >
                ...
                <ThemeProvider>
                    <HotkeyProvider>
                        ...
                        <a
                            href="#main-content"
                            className="fixed top-4 left-6 z-60 -translate-y-20 transform rounded-full bg-(--accent-b) px-4 py-2 text-sm font-semibold text-black transition focus-visible:translate-y-0"
                        >
                            Skip to content
                        </a>
