...
describe('InteractionController Integration', () => {
    ...
    it('should load interaction handlers from directory', async () => {
        ...
        await (seedcord.bot as unknown as TestBot).interactions.init();

        // Access private slashMap to verify registration
    ...
    it('should handle HMR updates for interaction handlers', async () => {
        ...
        let controller = (seedcord.bot as unknown as TestBot).interactions;
        ...
        await (seedcord.bot as unknown as TestBot).interactions.onHmr({
            file: filePath,
            type: 'update'
        });

        controller = (seedcord.bot as unknown as TestBot).interactions;
