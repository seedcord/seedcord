...
export function Navbar({ mark, search, actions, tabs, className }: NavbarProps): ReactElement {
    ...
    return (
        ...
        >
            <div className={cn(shellRowClassName, 'gap-4 py-4 md:gap-6')}>
                {mark}
                {search}
                <div className={cn('ml-auto flex shrink-0 items-center gap-2')}>{actions}</div>
            </div>
