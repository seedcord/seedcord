...
| [`discord-component-embed`](packages/discord-component-embed) | [![version](https://img.shields.io/npm/v/discord-component-embed?style=flat-square&logo=npm&logoColor=c8341f&label=&labelColor=1f1f1f&color=c8341f)](packages/discord-component-embed/CHANGELOG.md) | Build and check Discord link previews, with JSX or plain functions |
